...
require (
	...
	github.com/microsoft/kiota/abstractions/go v0.0.0-20220216133321-1457eed0a802
	github.com/microsoft/kiota/http/go/nethttp v0.0.0-20220216133321-1457eed0a802
